...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Order Confirmation - dailyBazaar</title>
                                    ...
                                    <td style="padding-top: 30px;">
                                        <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: center;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                                        Phone: 0304-5260527 | Email: daily@bazaar.com
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 18px; color: #666666; padding-bottom: 25px;">
                                                        <strong>Order Number:</strong> {{$order_details->order_id}} | <strong>Order Date:</strong> <?php echo date("F j, Y, g:i a", strtotime($order_details->created_at));  ?>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 14px; line-height: 18px; color: #757575; text-align: right; padding-bottom: 10px;">
                                                        <b style="color: #666666;">${{$item->product_price * $item->product_quantity}}</b> Total
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
