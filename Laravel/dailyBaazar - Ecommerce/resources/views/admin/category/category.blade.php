                                                ...
                                                <div class="_1vB07">
                                                                                        ...
                                                                                        <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                                                                            <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                                                                                <div class="Polaris-TextField__Prefix_10fbz" id="PolarisTextField25Prefix"><span class="Polaris-Filters__SearchIcon_158og"><span class="Polaris-Icon_yj27d Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                                                                                            ...
                                                                                                            </svg></span></span></div><input id="PolarisTextField25" placeholder="Filter Category"  class="Polaris-TextField__Input_30ock Polaris-TextField__Input--hasClearButton_15k6h" aria-labelledby="PolarisTextField25Label PolarisTextField25Prefix" aria-invalid="false" aria-multiline="false" value="">
                                                    ...
                                                    @foreach ($categories as $category)
                                                                    <tr class="_1Apqa _28DC1">
                                                                        ...
                                                                        <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;"><span class="Polaris-Thumbnail Polaris-Thumbnail--sizeMedium"><img src="{{asset('img/category-img/'.$category->image.'')}}" alt="Black choker necklace"></span>
  <div id="PolarisPortalsContainer"></div>
                                                                        ...
                                                                        <td class="_2ROf4">
                                                                            <div class="">
                                                                                ...
                                                                                href="/update-category/{{$category->slug}}" style="color: black;">{{$category->name}}</a></div>
                                                                                <div title="Monday, November 02, 2020"><?php echo date("F j, Y, g:i a", strtotime($category->created_at));  ?></div>
                                                                            </div>
                                                                        </td>
